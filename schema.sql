...
CREATE TABLE IF NOT EXISTS clinpgx_drug_annotation (
    ...
    annotation_id TEXT,   -- Source-specific annotation ID
    phenotype TEXT,
    significance TEXT,
    direction TEXT,
    notes TEXT,
...
CREATE INDEX idx_dbsnp_variant_rsid ON dbsnp_variant(rsid);
CREATE INDEX idx_dbsnp_variant_position ON dbsnp_variant(chrom, pos);
CREATE INDEX idx_variant_identifier_dbsnp_rsid ON variant_identifier_dbsnp(rsid);
CREATE INDEX idx_variant_identifier_dbsnp_id ON variant_identifier_dbsnp(id);